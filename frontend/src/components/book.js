...
export default function Book() {
    ...
    const [books, setBooks] = useState(data);// useState([]) fetch all books
    ...
    // To fetch all comments from Backend
    // useEffect(() => {
    //     axios.get('/comment')
    //         .then(res => {
    //             console.log(res)
    ...
    //     // axios.post(`/book/${params.id}/comment`, body, {
    ...
    //     // console.log(params.id + " BooK ID") // BookID
    //     // axios.post(`/book/${params.id}/favorite_list`, params.id, {
    //     //     headers: { "Content-Type": 'application/json' }
    //     // })
    //     //     .then(res => console.log("JSON comment is sent"))
    //     //     .catch(err => console.log(err))
        ...
        <div className='row'>
            <Row>
                ...
                {books.filter((book) => {
                    ...
                    <Col lg={5} sm={5} md={5} xs={5} key={book.bookID}>
